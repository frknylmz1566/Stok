...
import Model.ModelGetData;
import Model.stockModel;
import View.GUI;

public class StokGetData implements ICommand {
	public GUI gui;
	public stockModel model;
	public ModelGetData getData;
	
	public StokGetData(GUI gui) {
		this.gui=gui;
	}
	
	@Override
	public void execute() {
		getData = new ModelGetData(new stockModel(gui.TF_Stok_Kodu.getText(),
